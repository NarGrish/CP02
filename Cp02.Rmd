...
Diese Genauigkeit nennen wir Maschiengenauigkeit $\delta_M$ und ist definiert über die gößte reelle Zahl $\delta_M$, so dass der Rechner noch $ 1+ \delta_M = 1$ berechnet (Seite 12 \cite{DeltaM}).
