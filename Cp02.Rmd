...
\end{equation}
Vergleicht man diese Werte mit den erwarteten Genauigkeiten von $\delta_{Mf} \approx 6*10^{-8}$ für ``Floats`` und $\delta_{Md} \approx 1,1*10^{-16}$ für ``Double`` sieht man das die Genauigkeit des ``Doubles`` mit $\delta_{M} \approx 4.4*10^{-16}$ zwar bei uns etwas kleiner ist, jedoch in Näherung gut zum Literaturwert passt.
